<template>
  <div class="p-6 bg-green-50 min-h-screen">
    <h1 class="text-3xl font-bold text-green-700 mb-6">Coin History</h1>

    <p v-if="coinStore.loading" class="text-green-700 mb-4">Loading...</p>
    ...
    <div v-if="!coinStore.loading && coinStore.transactions.length === 0" class="text-green-700">
      You do not have any currency transactions yet.
    </div>
